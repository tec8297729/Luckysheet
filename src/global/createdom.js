...
export default function luckysheetcreatedom(colwidth, rowheight, data, menu, title) {
    ...
    let flowstr = replaceHtml('<div id="luckysheetcoltable_0" class="luckysheet-cell-flow-col"> <div id ="luckysheet-sheettable_0" class="luckysheet-cell-sheettable" style="height:${height}px;width:${width}px;"> <div id="luckysheet-print-line-x" style="top: ${printHeight}px"></div>   <div id="luckysheet-print-line-y" style="left: ${printWidth}px;  background-size: 100% 8px;"></div> </div><div id="luckysheet-bottom-controll-row" class="luckysheet-bottom-controll-row"> ' + bottomControll + ' </div> </div>', { "height": Store.rh_height, "width": Store.ch_width - 1, "printHeight": Store.print_height, "printWidth": Store.print_width });
    console.log('>>>>>>>');
